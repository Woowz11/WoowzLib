...
Упрощает работу с [VULKAN RENDER & CUSTOM WINDOWS], добавляет кеширование, и предупреждает если где-то что-то не так, к примеру имеет авто-очистки, содержит комментарии и try/catch и всё на Русском языке
