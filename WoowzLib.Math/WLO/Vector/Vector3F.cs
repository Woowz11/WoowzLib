...
public class Vector3F : IEquatable<Vector3F>{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator !=(Vector3F? L, Vector3F? R) => !(L == R);
