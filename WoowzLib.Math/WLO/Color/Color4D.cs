...
public struct Color4D : IEquatable<Color4D>{
	...
	public double R{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет R выходит за пределы [0, 1] у Color4D!");
			}
			__R = value;
		}
	}
	...
	public double G{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет G выходит за пределы [0, 1] у Color4D!");
			}
			__G = value;
		}
	}
	...
	public double B{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет B выходит за пределы [0, 1] у Color4D!");
			}
			__B = value;
		}
	}
	...
	public double A{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет A выходит за пределы [0, 1] у Color4D!");
			}
			__A = value;
		}
	}
	...
	public static readonly Color4D Orage = new Color4D(1.0, 0.5, 0, 1.0);
