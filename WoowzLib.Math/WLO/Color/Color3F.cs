...
public struct Color3F : IEquatable<Color3F>{
	...
	public float R{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет R выходит за пределы [0, 1] у Color3F!");
			}
			__R = value;
		}
	}
	...
	public float G{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет G выходит за пределы [0, 1] у Color3F!");
			}
			__G = value;
		}
	}
	...
	public float B{
		...
		set{
			if(value is < 0 or > 1){
				throw new Exception("Цвет B выходит за пределы [0, 1] у Color3F!");
			}
			__B = value;
		}
	}
	...
	public static readonly Color3F Orage = new Color3F(1f, 0.5f, 0);
